...
const mockServiceTypes: ServiceType[] = [
  { id: '1', name: 'Плановое техническое обслуживание кондиционера', category: 'Обслуживание', estimatedDuration: 90, baseCost: 3500, requiredCertifications: ['Монтаж климатических систем', 'Работа с хладагентами'], popularity: 312 },
  { id: '2', name: 'Чистка фильтров и теплообменника', category: 'Обслуживание', estimatedDuration: 45, baseCost: 1800, requiredCertifications: ['Монтаж климатических систем'], popularity: 285 },
  { id: '3', name: 'Заправка хладагентом', category: 'Обслуживание', estimatedDuration: 60, baseCost: 4200, requiredCertifications: ['Работа с хладагентами', 'Монтаж климатических систем'], popularity: 198 },
  { id: '4', name: 'Ремонт компрессора', category: 'Ремонт', estimatedDuration: 240, baseCost: 12000, requiredCertifications: ['Монтаж климатических систем', 'Работа с хладагентами', 'Допуск к электроустановкам'], popularity: 87 },
  { id: '5', name: 'Замена платы управления', category: 'Ремонт', estimatedDuration: 120, baseCost: 6500, requiredCertifications: ['Допуск к электроустановкам', 'Монтаж климатических систем'], popularity: 104 },
  { id: '6', name: 'Ремонт вентилятора наружного блока', category: 'Ремонт', estimatedDuration: 150, baseCost: 5800, requiredCertifications: ['Монтаж климатических систем', 'Допуск к электроустановкам'], popularity: 73 },
  { id: '7', name: 'Монтаж настенного кондиционера', category: 'Монтаж', estimatedDuration: 180, baseCost: 8000, requiredCertifications: ['Монтаж климатических систем', 'Работа с хладагентами', 'Работа на высоте'], popularity: 156 },
  { id: '8', name: 'Монтаж канального кондиционера', category: 'Монтаж', estimatedDuration: 360, baseCost: 22000, requiredCertifications: ['Монтаж климатических систем', 'Работа с хладагентами', 'Монтаж вентиляции'], popularity: 42 },
  { id: '9', name: 'Монтаж мультисплит-системы', category: 'Монтаж', estimatedDuration: 480, baseCost: 35000, requiredCertifications: ['Монтаж климатических систем', 'Работа с хладагентами', 'Работа на высоте', 'Допуск к электроустановкам'], popularity: 28 },
  { id: '10', name: 'Диагностика системы кондиционирования', category: 'Диагностика', estimatedDuration: 60, baseCost: 2500, requiredCertifications: ['Монтаж климатических систем'], popularity: 267 },
  { id: '11', name: 'Диагностика утечки хладагента', category: 'Диагностика', estimatedDuration: 45, baseCost: 2000, requiredCertifications: ['Работа с хладагентами'], popularity: 143 },
  { id: '12', name: 'Проверка электрооборудования', category: 'Диагностика', estimatedDuration: 30, baseCost: 1500, requiredCertifications: ['Допуск к электроустановкам'], popularity: 189 },
  { id: '13', name: 'Промывка системы вентиляции', category: 'Обслуживание', estimatedDuration: 120, baseCost: 5500, requiredCertifications: ['Монтаж вентиляции'], popularity: 61 },
  { id: '14', name: 'Демонтаж кондиционера', category: 'Монтаж', estimatedDuration: 90, baseCost: 4500, requiredCertifications: ['Монтаж климатических систем', 'Работа с хладагентами'], popularity: 95 },
  { id: '15', name: 'Замена дренажной системы', category: 'Ремонт', estimatedDuration: 75, baseCost: 3200, requiredCertifications: ['Монтаж климатических систем'], popularity: 112 },
];
